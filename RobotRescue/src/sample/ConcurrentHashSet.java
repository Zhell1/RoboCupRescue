...
public class ConcurrentHashSet<E> implements ConcurrentSet<E>, Serializable {
    ...
    private final ConcurrentHashMap<E, Object> m;
    private transient Set<E> s;

    public ConcurrentHashSet() {
        this.m = new ConcurrentHashMap<E, Object>();
        init();
    }
/*
    public ConcurrentHashSet(int initialCapacity) {
        this.m = (ConcurrentMap<E, Object>) new ConcurrentHashMap<E, Object>(initialCapacity);
        init();
    }

    public ConcurrentHashSet(int initialCapacity, float loadFactor) {
        this.m = (ConcurrentMap<E, Object>) new ConcurrentHashMap<E, Object>(initialCapacity, loadFactor);
        init();
    }

    public ConcurrentHashSet(int initialCapacity, float loadFactor, int concurrencyLevel) {
        this.m = (ConcurrentMap<E, Object>) new ConcurrentHashMap<E, Object>(initialCapacity, loadFactor, concurrencyLevel);
        init();
    }
    ...
    */
    ...
    public ConcurrentHashSet(Supplier<? extends ConcurrentMap<E, Object>> concurrentMapSupplier) {
        ...
        //   this.m = newMap;
        this.m = (ConcurrentHashMap<E, Object>) newMap;
        init();
    }
